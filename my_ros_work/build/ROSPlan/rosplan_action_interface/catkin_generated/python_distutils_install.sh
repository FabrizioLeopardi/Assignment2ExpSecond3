...
echo_and_run cd "/root/Desktop/my_ros_work/src/ROSPlan/rosplan_action_interface"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/Desktop/my_ros_work/src/ROSPlan/rosplan_action_interface/setup.py" \
     \
    build --build-base "/root/Desktop/my_ros_work/build/ROSPlan/rosplan_action_interface" \
    install \
    --root="${DESTDIR-/}" \
