...
echo_and_run cd "/root/Desktop/my_ros_work/src/ROSPlan/rosplan_rqt"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/Desktop/my_ros_work/src/ROSPlan/rosplan_rqt/setup.py" \
     \
    build --build-base "/root/Desktop/my_ros_work/build/ROSPlan/rosplan_rqt" \
    install \
    --root="${DESTDIR-/}" \
